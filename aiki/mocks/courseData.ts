...
function createCourse(
  courseData: Omit<Course, "moduleCount" | "estimatedHours">
): Course {
  // Calculate moduleCount from the modules array length
  const moduleCount = courseData.modules.length;

  // Calculate estimatedHours from lesson durations
...
export const courseDatabase: Course[] = [
  createCourse({
    ...
    instructorName: "Blockchain Architect",
    image:
  ...
  createCourse({
    ...
    instructorName: "Smart Contract Developer",
    image:
  ...
  createCourse({
    ...
    instructorName: "Data Engineering Lead",
    image:
  ...
  createCourse({
    ...
    instructorName: "AI & Blockchain Researcher",
    image:
  ...
  createCourse({
    ...
    instructorName: "Security Specialist",
    image:
...
export const getCoursesByFilter = (
  ...
  return courseDatabase.filter(predicate);
};
